...
listaProductosDest.addEventListener('click', agregarProducto)
...
const mostrarProductosDestacados = (data) => {
    const listaProductosDest = document.querySelector('#lista-productos-dest');
    const productosDestacados = data.filter(producto => producto.dest); // Aquí comprobamos si dest es igual a 1
